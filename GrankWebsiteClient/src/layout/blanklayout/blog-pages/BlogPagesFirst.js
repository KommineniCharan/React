...
const BlogPagesFirst = () => {
  return (
    <>
      <Seo
        title="Top 6 Real Estate Digital Marketing Tips to Boost Sales in 2022"
        description="Elevate your real estate sales with powerful digital marketing strategies. Discover expert tips to maximize online presence and drive property sales success."
        name="Company name."
        type="article"
