...
const BlogPagesSecond = () => {
  return (
    <>
      <Seo
        title="Why Digital Marketing Is Important for Branding"
        description="Discover why a strong online presence is crucial for effective branding in the digital age and help your brand to expand awareness, generate leads, and acquire new customers."
        name="Company name."
        type="article"
