  ...
  return (
    <>
      <Seo
        ...
        Brand Identity Agency in Bangalore | Hyderabad
        "
        description="Brand identity firm in Bangalore and Hyderabad. Explore how we can help you in crafting memorable and authentic identities that resonate with your target audience organically."
        name="Company name."
        type="article"
      ...
      <section className="section-top">
        ...
        <div className="branding-consulting-banner">
          ...
          <img
            ...
            src="assest/photos/branding/brand-identity-banner-mobile.png"
            alt="G-Rank"
          />
