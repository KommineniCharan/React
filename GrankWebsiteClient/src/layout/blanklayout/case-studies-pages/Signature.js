      ...
      <section className="section-top">
        ...
        >
          <img
            ...
            src="assest/photos/case-studies/signature-banner.png"
            alt="G-Rank"
          />
          <img
            className="img-fluid w-100 desktop-none"
            src="assest/photos/case-studies/signature-banner-mobile.png"
            alt="G-Rank"
          />

          <div className="case-sub-banner-div" style={{ color: "#FAC565" }}>
            <h2>Real Estate Industry</h2>
          </div>
          <div className="case-sub-banner-div2" style={{ color: "#FAC565" }}>
            ...
            <div className="row">
              <div className="col-12 col-md-6 col-lg-6 align-self-center">
                <img
                  ...
                  src="assest/photos/case-studies/sub-banner5.png"
                  alt="G-Rank"
                />
              </div>
                ...
                <div className="row">
                  <div className="col-12">
                    ...
                    <p className="section2-web-develop-passage">
                      Candeur Signature is a premium apartment project in
                      Varthur, Bangalore from the prestigious Candeur Group.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-12  result-img">
                <img
                  className="img-fluid "
                  src="assest/photos/case-studies/result-graph5.png"
                  alt="G-Rank"
                />
              </div>
            </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 result-text">
                <h1>
                  Over a course of 4 years, from 2020, leads increased from 2452
                  per year to 2932 to 4591 in the year 2022. Total Leads :
                  9,975.
                </h1>
                <h2>87%</h2>
